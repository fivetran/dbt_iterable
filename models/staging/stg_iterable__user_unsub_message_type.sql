...
final as (
    ...
    select
        ...
        rank() over(partition by email, message_type_id{{ fivetran_utils.partition_by_source_relation(package_name='iterable') }} order by updated_at desc) as latest_batch_index,
        {% else %}
